...
/**
 * A collection that contains no duplicate elements. More formally, a set
 * contains no pair of elements <code>e1</code> and <code>e2</code> such that
 * <code>e1.equals(e2)</code> is true, and and at most one null element (for the
 * simple reason that if it had contained two null elements, they would have
 * been duplicates).
 *
...
public interface Set<E> extends Iterable<E> {
	 ...
	 * returns true if and only if this set contains an element <code>e</code> such
	 * that <code>(o==null ? e==null :
	 * o.equals(e))</code>.
	 *
	 ...
	 *
	 * @param other the other <code>Set</code> to take the intersection with
